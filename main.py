...
def title_screen ():
    ...
    print("A Classical Game on a Quantum Computer")
    print("")
    print("")
    randPlace = input("> Press Enter to play...\n").upper()
    print("")
    print("We recomend grabbing a piece of paper to keep track of where your ships and the possible location of your opponent's ships are!")
    print("")
    print("")
def ask_for_device ():
    ...
    if (d=="Y"):
        ...
        device = BasicAer.get_backend('qasm_simulator') # otherwise, we use a simulator
        ...
        if  randPlace=="R":
            ...
            for ship in [0,1,2]:
                ...
                while (choosing):
                    ...
                    # get player input
                    print("> Player " + str(player+1) + ", choose a position for ship " + str(ship+1) + " (0, 1, 2, 3 or 4)")
                    position = input()
